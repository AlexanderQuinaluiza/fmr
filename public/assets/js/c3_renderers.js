(function() {
    ...
    callWithJQuery(function($, c3) {
      ...
      return $.pivotUtilities.c3_renderers = {
        "Gráfica barra horizontal": makeC3Chart({
          type: "bar",
          horizontal: true
        }),
        "Gráfica barra horizontal agrupada": makeC3Chart({
          type: "bar",
          stacked: true,
          horizontal: true
        }),
        "Gráfica de barras": makeC3Chart({
          type: "bar"
        }),
        "Gráfica de barras agrupada": makeC3Chart({
          type: "bar",
          stacked: true
        }),
        "Gráfica lineal": makeC3Chart(),
        "Gráfica de áreas": makeC3Chart({
          type: "area",
          stacked: true
        })
      };
