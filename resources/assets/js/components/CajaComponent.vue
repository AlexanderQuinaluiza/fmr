        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 id="titulo"><i class="fa fa-users"></i> Cajas </h4>
                </div>
                <div class="card-body">
                    <div class="custom-tab">
                        ...
                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            ...
                            <table id="table_cajas" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="DESCRIPCION_CAJA" required class="form-control" placeholder="Descripción o nombre de la caja" maxlength="110">
                                        </div>
                                         <div class="form-group col-md-6">
                                            <label>Agencia</label> 
                                        ...
                                        <!-- <input type="text" id="ID_AGE" required class="form-control" placeholder="Descripción o nombre de la caja" maxlength="110">-->
                                        </div>
...
<script>
        export default {
            ...
            datatable.setAttribute('src', 'assets/js/lib/data-table/datatableCajas.js')
