    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
          <h4 id="titulo">
            <i class="fa fa-file"></i> Reportes Ventas
          </h4>
        </div>
            ...
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a
                  ...
                  aria-selected="true"
                >
                  <i class="fa fa-list"></i> B.I. Ventas Usuarios
                </a>
                <a
                  class="nav-item nav-link"
                  id="listado1-tab"
                  ...
                  aria-selected="false"
                >
                  <i class="fa fa-list"></i> B.I. Ventas Productos
                </a>
                   <a
                  class="nav-item nav-link"
                  id="listado1-tab"
                  ...
                  aria-selected="false"
                >
                  <i class="fa fa-list"></i> B.I. Utilidades
                </a>
              </div>
            </nav>
