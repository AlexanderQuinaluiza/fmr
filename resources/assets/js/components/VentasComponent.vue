        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 id="titulo"><i class="fa fa-users"></i> Ventas </h4>
                </div>
                <div class="card-body">
                    <div class="custom-tab">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link" id="listado-tab" data-toggle="tab" href="#listado" role="tab" aria-controls="listado" aria-selected="true" ><i class="fa fa-list"></i> Busqueda </a>
                        ...
                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            ...
                            <table id="table_categorias" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Nombre</label>
                                            <input type="text" id="NOMBRE_CAT" required class="form-control" placeholder="Nombre de la categoria" maxlength="110">
                                        </div>
...
<script>
        export default {
            data(){
                return{
                   cabeceras : ["Id","Nombre","Precio","Acciones"]
                }
            },
            mounted() {              
